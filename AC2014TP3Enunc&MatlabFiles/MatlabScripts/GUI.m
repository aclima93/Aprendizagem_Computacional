...
% handles    structure with handles and user data (see GUIDATA)
    ...
    train_percentage = str2num(get(handles.training_percentage_edit, 'String'))/100;
    ...
    temp = get(handles.classification_method_popupmenu, 'String');
    classification_method = temp(get(handles.classification_method_popupmenu, 'Value'));
    ...
    set(handles.sensitivity_edit,'String', results_data(3)*100); % sensitivity
    set(handles.true_positives_edit,'String', results_data(4)); % t_p
    set(handles.true_negatives_edit,'String', results_data(5)); % t_n
    set(handles.false_positives_edit,'String', results_data(6)); % f_p
    set(handles.false_negatives_edit,'String', results_data(7)); % f_n
    set(handles.ictals_edit,'String', results_data(8)); % binary_positives
    set(handles.non_ictals_edit,'String', results_data(9)); % binary_negatives
...
function ictals_edit_Callback(hObject, eventdata, handles)
% hObject    handle to ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ictals_edit as text
%        str2double(get(hObject,'String')) returns contents of ictals_edit as a double


% --- Executes during object creation, after setting all properties.
function ictals_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function non_ictals_edit_Callback(hObject, eventdata, handles)
% hObject    handle to non_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of non_ictals_edit as text
%        str2double(get(hObject,'String')) returns contents of non_ictals_edit as a double


% --- Executes during object creation, after setting all properties.
function non_ictals_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to non_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function expected_ictals_edit_Callback(hObject, eventdata, handles)
% hObject    handle to expected_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of expected_ictals_edit as text
%        str2double(get(hObject,'String')) returns contents of expected_ictals_edit as a double


% --- Executes during object creation, after setting all properties.
function expected_ictals_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to expected_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function expected_non_ictals_edit_Callback(hObject, eventdata, handles)
% hObject    handle to expected_non_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of expected_non_ictals_edit as text
%        str2double(get(hObject,'String')) returns contents of expected_non_ictals_edit as a double


% --- Executes during object creation, after setting all properties.
function expected_non_ictals_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to expected_non_ictals_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function invalids_edit_Callback(hObject, eventdata, handles)
% hObject    handle to invalids_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of invalids_edit as text
%        str2double(get(hObject,'String')) returns contents of invalids_edit as a double


% --- Executes during object creation, after setting all properties.
function invalids_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to invalids_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
