function [filename, performance, network_outputs, binary_results, results_data] = mlnn( showUI, net_type, data_id, train_percentage, train_func, hidden_layers, classification_method, num_characteristics )
