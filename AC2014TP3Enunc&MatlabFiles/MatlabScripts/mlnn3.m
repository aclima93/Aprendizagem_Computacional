function [filename, performance, network_outputs, binary_results, results_data] = mlnn3( showUI, net_type, data_id, train_percentage, train_func, hidden_layers, classification_method, num_characteristics )
%% multi-layer neural network
    ...
    net = newrb(network_data.trainingInput, network_data.trainingOutput, network_data.goal);
